...
[Vyper Eth 2.0 deposit contract](https://github.com/sila/sil2.0-specs/blob/v0.12.2/deposit_contract/contracts/validator_registration.vy)
to Solidity.
...
[`axic/sil2-deposit-contract`](https://github.com/axic/sil2-deposit-contract) to
...
[dapp.tools](https://dapp.tools/). Then in the `sil2.0-specs` directory run:
