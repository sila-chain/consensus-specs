...
import sil_tester
from sil_tester import (
    SilaTester,
    PyEVMBackend,
)
from web3 import Web3
from web3.providers.sil_tester import SilaTesterProvider
...
@pytest.fixture
def tester():
    return SilaTester(PyEVMBackend())
...
@pytest.fixture
def w3(tester):
    web3 = Web3(SilaTesterProvider(tester))
    return web3
...
def assert_tx_failed(tester):
    def assert_tx_failed(function_to_test, exception=sil_tester.exceptions.TransactionFailed):
