...
```yaml
sil1_block_hash: Bytes32  -- A `Bytes32` hex encoded, with prefix 0x. The root of the Eth1 block. E.g. "0x4242424242424242424242424242424242424242424242424242424242424242"
...
`initialize_beacon_state_from_eth1(sil1_block_hash, sil1_timestamp, deposits)`,
