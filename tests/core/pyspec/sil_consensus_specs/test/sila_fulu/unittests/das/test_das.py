...
from sil_consensus_specs.test.helpers.fork_choice import BlobData, with_blob_data
...
def run_is_data_available_sila_peerdas_test(spec, blob_data):
    def callback():
...
@with_sila_fulu_and_later
@spec_state_test
def test_is_data_available_sila_peerdas(spec, state):
    ...
    result = run_is_data_available_sila_peerdas_test(spec, blob_data)
