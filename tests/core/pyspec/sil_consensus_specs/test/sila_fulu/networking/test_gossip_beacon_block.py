...
from sil_consensus_specs.test.helpers.blob import get_block_with_blob, get_max_blob_count
...
def test_gossip_beacon_block__valid_at_blob_parameters_limit(spec, state):
    ...
    blob kzg commitments passes gossip validation under SIP-7892.
    """
    ...
    # forgets SIP-7892 and uses MAX_BLOBS_PER_BLOCK_ELECTRA would reject this block.
