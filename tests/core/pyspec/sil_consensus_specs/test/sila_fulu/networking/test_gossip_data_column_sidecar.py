...
from sil_consensus_specs.test.helpers.constants import SILA_FULU
...
def test_gossip_data_column_sidecar__valid(spec, state):
    ...
    # Sanity check: the BLOB_SCHEDULE override should be exercising the SilaFulu
    # code path (`get_blob_parameters`), not the Electra fallback. A client that
    # forgets SIP-7892 and uses MAX_BLOBS_PER_BLOCK_ELECTRA would reject this sidecar.
