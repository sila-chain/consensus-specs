...
from sil_consensus_specs.debug import encode, random_value
...
from sil_consensus_specs.test.helpers.constants import SILA_MAINNET, MINIMAL, TESTGEN_FORKS
from sil_consensus_specs.test.utils.manifest import Manifest, manifest
from sil_consensus_specs.test.utils.template_test import template_test
from sil_consensus_specs.utils.ssz.ssz_impl import (
    hash_tree_root,
    serialize,
)
from sil_consensus_specs.utils.ssz.ssz_typing import Container, ProgressiveContainer
...
def _create_test_cases():
    ...
    settings.append((SILA_MAINNET, random_value.RandomizationMode.mode_random, False, 5))
