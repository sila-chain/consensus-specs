...
from sil_consensus_specs.test.helpers.gloas.fork import GLOAS_FORK_TEST_META_TAGS
...
@with_phases(phases=[SILA_FULU], other_phases=[GLOAS])
@spec_test
@with_state
...
def test_fork_proposer_lookahead_slashed_validators_carried_over(spec, phases, state):
    ...
    # Both halves were computed under SilaFulu, so both still have slashed validators
