...
from sil_consensus_specs.test.helpers.deposits import build_deposit_data
from sil_consensus_specs.test.helpers.gloas.fork import (
...
def create_pending_deposit_for_validator(spec, validator_index, amount):
    ...
    # SIL1 withdrawal credentials
    withdrawal_credentials = spec.SIL1_ADDRESS_WITHDRAWAL_PREFIX + b"\x00" * 11 + b"\xab" * 20
