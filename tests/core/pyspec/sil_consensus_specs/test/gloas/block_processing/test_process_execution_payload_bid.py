...
from sil_consensus_specs.test.helpers.execution_payload_bid import (
...
def test_process_execution_payload_bid_insufficient_balance_with_pending_payments(spec, state):
    ...
    balance = spec.MIN_DEPOSIT_AMOUNT + spec.Gwei(1000)  # 1 SIL + 1000 gwei
...
def test_process_execution_payload_bid_sufficient_balance_with_pending_payments(spec, state):
    ...
    # Set up scenario: balance=2000 SIL, bid=600, existing_pending=500, min_activation=32ETH
