...
from sil_consensus_specs.test.helpers.gloas.state import initialize_ptc_window
from sil_consensus_specs.test.helpers.keys import privkeys
from sil_consensus_specs.test.helpers.state import next_epoch
from sil_consensus_specs.utils.ssz.ssz_typing import Bitvector
...
@with_gloas_and_later
@with_presets([MINIMAL], reason="sila_mainnet preset requires a much larger validator set")
