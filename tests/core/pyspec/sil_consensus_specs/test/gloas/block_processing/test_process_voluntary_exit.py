...
from sil_consensus_specs.test.helpers.keys import builder_pubkey_to_privkey
from sil_consensus_specs.test.helpers.state import next_slots
from sil_consensus_specs.test.helpers.voluntary_exits import sign_voluntary_exit
