...
from sil_consensus_specs.test.helpers.constants import BELLATRIX, CAPELLA, SILA_DENEB, ELECTRA, SILA_FULU
...
@with_phases([BELLATRIX, CAPELLA, SILA_DENEB, ELECTRA, SILA_FULU])
@spec_state_test
