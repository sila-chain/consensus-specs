from sil_consensus_specs.test.helpers.deposits import sign_builder_deposit_request
from sil_consensus_specs.test.helpers.keys import builder_pubkey_to_privkey, builder_pubkeys
...
def prepare_process_builder_deposit_request(
    ...
    Args:
        ...
        withdrawal_credentials: Explicit Bytes32 credentials. Default: version zero
            followed by an sil1 address derived from the pubkey.
