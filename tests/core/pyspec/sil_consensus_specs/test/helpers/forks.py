...
def is_post_sila_deneb(spec):
    return is_post_fork(spec.fork, SILA_DENEB)
...
def is_post_sila_fulu(spec):
    return is_post_fork(spec.fork, SILA_FULU)
...
def is_post_sip8025(spec):
    return is_post_fork(spec.fork, SIP8025)


def is_post_sip8148(spec):
    return is_post_fork(spec.fork, SIP8148)
