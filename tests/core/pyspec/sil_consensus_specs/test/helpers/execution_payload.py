...
from sil_consensus_specs.debug.random_value import get_random_bytes_list
...
from sil_consensus_specs.test.helpers.withdrawals import get_expected_withdrawals
...
def compute_el_block_hash_with_new_fields(spec, payload, parent_beacon_block_root, requests_hash):
    ...
    if not is_post_sila_deneb(spec):
        parent_beacon_block_root = None
