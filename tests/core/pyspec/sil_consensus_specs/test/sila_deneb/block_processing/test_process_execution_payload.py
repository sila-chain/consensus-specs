...
from sil_consensus_specs.test.helpers.constants import SILA_DENEB, GLOAS
from sil_consensus_specs.test.helpers.execution_payload import (
    build_empty_execution_payload,
    compute_el_block_hash,
    get_execution_payload_header,
)
from sil_consensus_specs.test.helpers.forks import is_post_sip8025
...
@with_all_phases_from_to(SILA_DENEB, GLOAS)
@spec_state_test
