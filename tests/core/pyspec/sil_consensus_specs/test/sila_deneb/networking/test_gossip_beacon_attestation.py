...
from sil_consensus_specs.test.helpers.constants import SILA_DENEB, ELECTRA, SILA_FULU
from sil_consensus_specs.test.helpers.fork_choice import (
    get_genesis_forkchoice_store_and_block,
)
from sil_consensus_specs.test.helpers.forks import is_post_electra
from sil_consensus_specs.test.helpers.gossip import (
    get_filename,
    get_seen,
    run_validate_gossip,
    wrap_genesis_block,
)
from sil_consensus_specs.test.helpers.keys import privkeys
...
@with_phases([SILA_DENEB, ELECTRA, SILA_FULU])
@spec_state_test
...
def test_gossip_beacon_attestation__ignores_first_slot_before_epoch_window_opens(spec, state):
    """
    Test that a first-slot attestation is ignored just before the SilaDeneb epoch
...
def test_gossip_beacon_attestation__accepts_first_slot_when_epoch_window_opens(spec, state):
    """Test that a first-slot attestation is accepted when the SilaDeneb epoch window opens."""
    yield "topic", "meta", "beacon_attestation"
...
def test_gossip_beacon_attestation__accepts_first_slot_when_epoch_window_closes(spec, state):
    """Test that a first-slot attestation is accepted at the last valid SilaDeneb epoch time."""
    yield "topic", "meta", "beacon_attestation"
...
def test_gossip_beacon_attestation__ignores_first_slot_after_epoch_window_closes(spec, state):
    """Test that a first-slot attestation is ignored after the SilaDeneb epoch window closes."""
    yield "topic", "meta", "beacon_attestation"
...
def test_gossip_beacon_attestation__accepts_last_slot_when_epoch_window_closes(spec, state):
    """Test that a last-slot attestation is accepted at the last valid SilaDeneb epoch time."""
    yield "topic", "meta", "beacon_attestation"
...
def test_gossip_beacon_attestation__ignores_last_slot_after_epoch_window_closes(spec, state):
    """Test that a last-slot attestation is ignored after the SilaDeneb epoch window closes."""
    yield "topic", "meta", "beacon_attestation"
