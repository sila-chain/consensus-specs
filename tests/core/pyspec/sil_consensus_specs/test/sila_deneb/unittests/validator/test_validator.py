...
from sil_consensus_specs.test.context import spec_state_test, with_all_phases_from_to
from sil_consensus_specs.test.helpers.blob import (
    get_sample_blob_tx,
)
from sil_consensus_specs.test.helpers.block import build_empty_block_for_next_slot, sign_block
...
@with_all_phases_from_to(SILA_DENEB, SILA_FULU)
@spec_state_test
