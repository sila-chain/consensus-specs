...
from sil_consensus_specs.test.gloas.block_processing.test_process_execution_payload_bid import (
...
from sil_consensus_specs.test.helpers.state import next_epoch_with_full_participation
