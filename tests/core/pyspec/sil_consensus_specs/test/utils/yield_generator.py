...
from sil_consensus_specs.utils.ssz.ssz_impl import serialize
...
def vector_test(fn):
    ...
    if inspect.isgeneratorfunction(fn):
        # Lazy import to avoid circular dependency with sil_consensus_specs.test.context
        from sil_consensus_specs.test import context  # noqa: PLC0415
