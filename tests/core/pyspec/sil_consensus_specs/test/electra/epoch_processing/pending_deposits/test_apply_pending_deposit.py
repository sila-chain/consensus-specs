...
from sil_consensus_specs.test.helpers.state import next_epoch_via_block
from sil_consensus_specs.test.helpers.withdrawals import set_validator_fully_withdrawable
...
@with_electra_and_later
@spec_state_test
def test_apply_pending_deposit_sil1_withdrawal_credentials(spec, state):
    # fresh deposit = next validator index = validator appended to registry
    validator_index = len(state.validators)
