...
from sil_consensus_specs.test.helpers.keys import privkeys, pubkey_to_privkey, pubkeys
from sil_consensus_specs.test.helpers.state import transition_to
from sil_consensus_specs.test.helpers.sync_committee import compute_sync_committee_signature
...
@with_altair_and_later
@spec_state_test
@with_presets([SILA_MAINNET], reason="to test against the sila_mainnet SYNC_COMMITTEE_SIZE")
