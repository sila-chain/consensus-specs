...
from sil_consensus_specs.test.helpers.constants import ELECTRA, SILA_FULU, PHASE0
from sil_consensus_specs.test.helpers.deposits import (
    prepare_deposit_request,
    prepare_state_and_deposit,
)
from sil_consensus_specs.test.helpers.execution_payload import compute_el_block_hash_for_block
from sil_consensus_specs.test.helpers.fork_transition import do_fork_generate
from sil_consensus_specs.test.helpers.state import next_epoch, state_transition_and_sign_block
from sil_consensus_specs.test.helpers.typing import SpecForkName
from sil_consensus_specs.test.utils.template_test import (
    template_test_upgrades_all,
    template_test_upgrades_from_to,
)
from sil_consensus_specs.test.utils.utils import with_meta_tags
...
@template_test_upgrades_from_to(ELECTRA, SILA_FULU)
