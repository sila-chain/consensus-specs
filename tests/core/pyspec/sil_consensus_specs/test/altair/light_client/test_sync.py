...
from sil_consensus_specs.test.helpers.genesis import create_signed_genesis_block
from sil_consensus_specs.test.helpers.light_client import (
...
@with_all_phases_from_to(ALTAIR, SILA_DENEB, other_phases=[CAPELLA, SILA_DENEB])
@spec_test
@with_state
@with_matching_spec_config(emitted_fork=SILA_DENEB)
@with_presets([MINIMAL], reason="too slow")
def test_sila_deneb_store_with_legacy_data(spec, phases, state):
    yield from run_lc_sync_test_upgraded_store_with_legacy_data(spec, phases, state, SILA_DENEB)


@with_all_phases_from_to(ALTAIR, ELECTRA, other_phases=[CAPELLA, SILA_DENEB, ELECTRA])
@spec_test
@with_state
...
@with_all_phases_from_to(ALTAIR, GLOAS, other_phases=[CAPELLA, SILA_DENEB, ELECTRA, GLOAS])
@spec_test
@with_state
