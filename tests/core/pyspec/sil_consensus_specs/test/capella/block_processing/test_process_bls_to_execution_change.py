...
from sil_consensus_specs.test.helpers.constants import CAPELLA, SILA_MAINNET
...
@with_phases([CAPELLA])
@with_presets([SILA_MAINNET], reason="use sila_mainnet fork version")
@spec_state_test
@always_bls
def test_valid_signature_from_staking_deposit_cli(spec, state):
    ...
    # Use sila_mainnet `genesis_validators_root`
