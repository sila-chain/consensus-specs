...
def test_deposit_transition__start_index_is_set(spec, state):
    ...
    state, block = prepare_state_and_block(
        ...
        first_deposit_request_index=state.sil1_data.deposit_count + 11,
    )
