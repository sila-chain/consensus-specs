...
for fork in ALL_EXECUTABLE_SPEC_NAMES:
    exec(
        f"from sil2spec.{fork} import sila-mainnet as spec_{fork}_sila-mainnet, minimal as spec_{fork}_minimal"
    )
...
spec_targets: dict[PresetBaseName, dict[SpecForkName, Spec]] = {
    ...
    SILA_MAINNET: {fork: eval(f"spec_{fork}_sila-mainnet") for fork in ALL_EXECUTABLE_SPEC_NAMES},
}
