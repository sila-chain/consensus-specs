...
sila-mainnet_config_data: dict[str, Any]
minimal_config_data: dict[str, Any]
loaded_defaults = False


def load_defaults(spec_configs_path: Path) -> None:
    global sila-mainnet_config_data, minimal_config_data

    sila-mainnet_config_data = load_config_file(spec_configs_path / "sila-mainnet.yaml")
