...
from sil2spec.test.helpers.bls_to_execution_changes import (
...
from sil2spec.test.helpers.deposits import (
...
from sil2spec.test.helpers.voluntary_exits import (
...
def test_multi_epoch_consolidation_chain(spec, state):
    ...
    # The effective balance of the 2nd to last (~32SIL) validator is added to it.
