...
from sil2spec.test.helpers.forks import is_post_electra, is_post_gloas
...
def test_top_up_to_fully_withdrawn_validator(spec, state):
    ...
    # With sila-mainnet preset, it holds
...
@with_capella_and_later
@with_presets([MINIMAL], reason="too many validators with sila-mainnet config")
@spec_state_test
