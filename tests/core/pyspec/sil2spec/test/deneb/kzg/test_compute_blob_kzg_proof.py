...
from sil2spec.test.context import only_generator, single_phase, spec_test, with_phases
from sil2spec.test.helpers.constants import DENEB
from sil2spec.test.utils.kzg_tests import G1, INVALID_BLOBS, INVALID_G1_POINTS, VALID_BLOBS
...
def _compute_blob_kzg_proof_case_valid_blob(blob_index):
    ...
    @manifest(preset_name="general", suite_name="kzg-sila-mainnet")
