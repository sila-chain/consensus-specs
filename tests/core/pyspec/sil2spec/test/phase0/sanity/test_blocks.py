...
from sil2spec.test.helpers.attestations import get_valid_attestation
from sil2spec.test.helpers.attester_slashings import (
    get_indexed_attestation_participants,
    get_max_attester_slashings,
    get_valid_attester_slashing,
    get_valid_attester_slashing_by_indices,
)
from sil2spec.test.helpers.block import (
    build_empty_block,
    build_empty_block_for_next_slot,
    sign_block,
    transition_unsigned_block,
)
from sil2spec.test.helpers.constants import MINIMAL, PHASE0
from sil2spec.test.helpers.deposits import prepare_state_and_deposit
...
from sil2spec.test.helpers.multi_operations import (
    run_slash_and_exit,
    run_test_full_random_operations,
)
from sil2spec.test.helpers.proposer_slashings import (
...
from sil2spec.test.helpers.sync_committee import (
    compute_committee_indices,
    compute_sync_committee_participant_reward_and_penalty,
)
from sil2spec.test.helpers.voluntary_exits import prepare_signed_exits
...
@with_presets(
    [MINIMAL],
    reason="sila-mainnet config leads to larger validator set than limit of public/private keys pre-generated",
)
@spec_test
@with_custom_state(
...
def test_empty_epoch_transition_not_finalizing(spec, state):
    if spec.SLOTS_PER_EPOCH > 8:
        return dump_skipping_message(
            "Skip sila-mainnet config for saving time."
