...
from sil2spec.test.context import MINIMAL, spec_state_test, with_altair_and_later, with_presets
...
def test_on_block_finalized_skip_slots(spec, state):
    """
    Test case was originally from https://github.com/sila/consensus-specs/pull/1579
