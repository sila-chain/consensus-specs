...
with_sip7441_and_later = with_all_phases_from(SIP7441, all_phases=ALLOWED_TEST_RUNNER_FORKS)
with_sip7805_and_later = with_all_phases_from(SIP7805, all_phases=ALLOWED_TEST_RUNNER_FORKS)
with_sip7928_and_later = with_all_phases_from(SIP7928, all_phases=ALLOWED_TEST_RUNNER_FORKS)
