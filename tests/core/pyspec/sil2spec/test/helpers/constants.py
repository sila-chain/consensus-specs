...
SIP7441 = SpecForkName("sip7441")
SIP7805 = SpecForkName("sip7805")
SIP7928 = SpecForkName("sip7928")
...
SILA_MAINNET_FORKS = (PHASE0, ALTAIR, BELLATRIX, CAPELLA, DENEB, ELECTRA)
...
LIGHT_CLIENT_TESTING_FORKS = [item for item in SILA_MAINNET_FORKS if item != PHASE0] + [FULU]
# The forks that output to the test vectors.
TESTGEN_FORKS = (*SILA_MAINNET_FORKS, FULU, GLOAS, SIP7805)
# Forks allowed in the test runner `--fork` flag, to fail fast in case of typos
ALLOWED_TEST_RUNNER_FORKS = (*ALL_PHASES, SIP7441)
...
# Config and Preset
#
SILA_MAINNET = PresetBaseName("sila-mainnet")
