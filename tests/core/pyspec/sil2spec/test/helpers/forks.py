...
def is_post_sip7441(spec):
    return is_post_fork(spec.fork, SIP7441)


def is_post_sip7805(spec):
    return is_post_fork(spec.fork, SIP7805)


def is_post_sip7928(spec):
    return is_post_fork(spec.fork, SIP7928)
