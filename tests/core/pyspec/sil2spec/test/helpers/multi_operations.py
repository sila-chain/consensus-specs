...
from sil2spec.test.helpers.attestations import get_max_attestations, get_valid_attestation
from sil2spec.test.helpers.attester_slashings import get_valid_attester_slashing_by_indices
from sil2spec.test.helpers.block import (
    build_empty_block_for_next_slot,
)
from sil2spec.test.helpers.bls_to_execution_changes import get_signed_address_change
from sil2spec.test.helpers.deposits import build_deposit, deposit_from_context
from sil2spec.test.helpers.forks import is_post_electra
from sil2spec.test.helpers.keys import privkeys, pubkeys
from sil2spec.test.helpers.proposer_slashings import get_valid_proposer_slashing
...
def prepare_state_and_get_random_deposits(spec, state, rng, num_deposits=None):
    ...
    state.sil1_data.deposit_count += len(deposits)
    return deposits
