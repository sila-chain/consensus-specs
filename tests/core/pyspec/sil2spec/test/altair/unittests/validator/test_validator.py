...
from sil2spec.test.helpers.sync_committee import compute_sync_committee_signature
from sil2spec.utils import bls
from sil2spec.utils.ssz.ssz_typing import Bitvector
...
@with_altair_and_later
@spec_state_test
@with_presets([SILA_MAINNET], reason="to test against the sila-mainnet SYNC_COMMITTEE_SIZE")
