from pysetup.constants import SILA_FULU

from .base import BaseSpecBuilder


class SilaFuluSpecBuilder(BaseSpecBuilder):
    fork: str = SILA_FULU
...
from sil_consensus_specs.electra import {preset_name} as electra
"""
...
"""
    ...
    def deprecate_functions(cls) -> set[str]:
        return {
            ...
            "get_blob_sidecars",
            "get_sil1_pending_deposit_count",
            "get_sil1_vote",
            "process_deposit",
            "upgrade_to_electra",
