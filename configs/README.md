...
sila-mainnet. A client binary may be compiled for a specific `PRESET_BASE`, and
then load different configurations around that preset to participate in
different networks or tests.

Standard configs:

- [`sila-mainnet.yaml`](./sila-mainnet.yaml): SilaMainnet configuration
