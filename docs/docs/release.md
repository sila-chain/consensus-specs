...
Next, update the `VERSION.txt` file which contains the sil2spec version.

> [!TIP]
> Click on the following link to open the GitHub editor for this file:
>
> - https://github.com/sila/consensus-specs/edit/master/tests/core/pyspec/sil2spec/VERSION.txt
...
https://github.com/sila/consensus-specs/releases/tag/<version>
```
