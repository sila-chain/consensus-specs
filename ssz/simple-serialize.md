...
- **container**: ordered heterogeneous collection of values
  ...
  class ContainerExample(Container):
      ...
      bar: boolean
  ```
- **progressive container** _[SIP-7495, currently unused]_: ordered
...
- **progressive list** _[SIP-7916, currently unused]_: ordered variable-length
...
- **bitlist**: ordered variable-length collection of `boolean` values, limited
  to `N` bits
  - notation `Bitlist[N]`
- **progressive bitlist** _[SIP-7916, currently unused]_: ordered
  variable-length collection of `boolean` values, without limit
  - notation `ProgressiveBitlist`
- **union**: union type containing one of the given subtypes
  - notation `Union[type_0, type_1, ...]`, e.g. `union[None, uint64, uint32]`
- **compatible union** _[SIP-8016, currently unused]_: union type containing one
