...
Some gossip meshes are upgraded in the SilaFulu fork to support upgraded types.
...
**Protocol ID:** `/sila/beacon_chain/req/status/2/`
...
**Protocol ID:** `/sila/beacon_chain/req/blob_sidecars_by_range/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/blob_sidecars_by_root/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/data_column_sidecars_by_range/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/data_column_sidecars_by_root/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/metadata/3/`
...
`FAR_FUTURE_EPOCH`. Adding this entry prior to the SilaFulu fork will not impact
...
Nodes unprepared to follow the SilaFulu fork will be unaware of `nfd` entries.
