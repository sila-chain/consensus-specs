...
[polynomial-commitments.md](../sila_deneb/polynomial-commitments.md) with the
functions required for data availability sampling (DAS). It is not part of the
core SilaDeneb specification but an extension that can be optionally implemented to
...
| Name                                                                                                                                                    | SSZ equivalent                                       | Description                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------ |
| [`PolynomialCoeff`](https://github.com/sila-chain/consensus-specs/blob/36a5719b78523c057065515c8f8fcaeba75d065b/pysetup/spec_builders/sip7594.py#L20-L24) | `List[BLSFieldElement, FIELD_ELEMENTS_PER_EXT_BLOB]` | <!-- predefined-type --> A polynomial in coefficient form    |
| [`Coset`](https://github.com/sila-chain/consensus-specs/blob/36a5719b78523c057065515c8f8fcaeba75d065b/pysetup/spec_builders/sip7594.py#L27-L33)           | `Vector[BLSFieldElement, FIELD_ELEMENTS_PER_CELL]`   | <!-- predefined-type --> The evaluation domain of a cell     |
| [`CosetEvals`](https://github.com/sila-chain/consensus-specs/blob/36a5719b78523c057065515c8f8fcaeba75d065b/pysetup/spec_builders/sip7594.py#L36-L42)      | `Vector[BLSFieldElement, FIELD_ELEMENTS_PER_CELL]`   | <!-- predefined-type --> A cell's evaluations over its coset |
...
def recover_cells_and_kzg_proofs(
    ...
    https://github.com/sila-chain/research/blob/51b530a53bd4147d123ab3e390a9d08605c2cdb8/polynomial_reconstruction/polynomial_reconstruction_danksharding.py
