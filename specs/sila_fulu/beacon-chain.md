...
SilaFulu is a consensus-layer upgrade containing a number of features. Including:

- [SIP-7594](https://sips.sila.org/SIPS/sip-7594): SilaPeerDAS - Peer Data
  Availability Sampling
- [SIP-7917](https://sips.sila.org/SIPS/sip-7917): Deterministic proposer
  lookahead
- [SIP-7892](https://sips.sila.org/SIPS/sip-7892): Blob Parameter Only
  Hardforks
...
`SILA_FULU_FORK_EPOCH`. The maximum blobs per block limit in each entry MUST be less
...
*Note*: The function `process_epoch` is modified in SilaFulu to call
