# SilaDeneb -- Polynomial Commitments
...
| Name                                                                                                                                                  | SSZ equivalent                                     | Description                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------- |
| [`BLSFieldElement`](https://github.com/sila-chain/consensus-specs/blob/36a5719b78523c057065515c8f8fcaeba75d065b/pysetup/spec_builders/sila_deneb.py#L18-L19) | `uint256`                                          | <!-- predefined-type --> A value in the finite field defined by `BLS_MODULUS` |
| [`Polynomial`](https://github.com/sila-chain/consensus-specs/blob/36a5719b78523c057065515c8f8fcaeba75d065b/pysetup/spec_builders/sila_deneb.py#L22-L28)      | `Vector[BLSFieldElement, FIELD_ELEMENTS_PER_BLOB]` | <!-- predefined-type --> A polynomial in evaluation form                      |
...
def compute_quotient_eval_within_domain(
    ...
    For more details, read https://dankradfeist.de/sila/2021/06/18/pcs-multiproofs.html section "Dividing
