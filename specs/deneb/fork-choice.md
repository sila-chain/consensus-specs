...
This is the modification of the fork choice accompanying the SilaDeneb upgrade.

## Helpers

### Modified `PayloadAttributes`

`PayloadAttributes` is extended with the parent beacon block root for SIP-4788.
