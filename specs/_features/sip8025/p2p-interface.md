...
This document contains the networking specifications for SIP-8025.
...
def compute_max_request_execution_proofs() -> uint64:
    ...
    """
    return uint64(MAX_REQUEST_BLOCKS_SILA_DENEB * MAX_EXECUTION_PROOFS_PER_PAYLOAD)
```
...
**Protocol ID:** `/sil2/beacon_chain/req/execution_proofs_by_range/1/`
...
**Protocol ID:** `/sil2/beacon_chain/req/execution_proofs_by_root/1/`

Request Content:

```
(
  List[ProofByRootIdentifier, MAX_REQUEST_BLOCKS_SILA_DENEB]
)
```
...
**Protocol ID:** `/sil2/beacon_chain/req/execution_proof_status/1/`
