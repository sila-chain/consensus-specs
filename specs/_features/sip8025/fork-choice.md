...
This document contains the fork-choice modifications for SIP-8025.
...
*Note*: `verify_execution_payload_envelope` is modified in SIP-8025 to require
...
*Note*: `on_execution_payload_envelope` is modified in SIP-8025 to pass
