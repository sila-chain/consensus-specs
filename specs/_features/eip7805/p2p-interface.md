...
- [Modifications in SIP-7805](#modifications-in-sip-7805)
...
def compute_fork_version(epoch: Epoch) -> Version:
    ...
    """
    if epoch >= SIP7805_FORK_EPOCH:
        return SIP7805_FORK_VERSION
...
SIP-7805 introduces a new global topic for inclusion lists.
...
**Protocol ID:** `/sila/beacon_chain/req/inclusion_list_by_committee_indices/1/`
...
| ---------------------- | ------------------------------ |
| `SIP7805_FORK_VERSION` | `SIP-7805.SignedInclusionList` |
