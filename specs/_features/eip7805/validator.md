...
validator" to implement SIP-7805.

## Prerequisites

This document is an extension of the
[SilaFulu -- Honest Validator](../../fulu/validator.md) guide. All behaviors and
...
updated Beacon Chain doc of [SIP-7805](./beacon-chain.md) are requisite for this
