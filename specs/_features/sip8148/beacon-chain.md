...
chain as part of the SIP-8148 upgrade.
...
| ---------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------- |
| `MAX_SET_SWEEP_THRESHOLD_REQUESTS_PER_PAYLOAD` | `uint64(2**4)` (= 16) | *[New in SIP8148]* Maximum number of execution layer set sweep threshold requests in each payload |
