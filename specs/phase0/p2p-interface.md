...
have form: `/sila/ForkDigestValue/Name/Encoding`. This defines both the type of
...
- `ssz_snappy` - All objects are SSZ-encoded and then compressed with
  ...
  `/sila/446a7232/beacon_aggregate_and_proof/ssz_snappy`, the fork digest is
...
- `ProtocolPrefix` - messages are grouped into families identified by a shared
  libp2p protocol name prefix. In this case, we use `/sila/beacon_chain/req`.
...
**Protocol ID:** `/sila/beacon_chain/req/status/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/goodbye/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/beacon_blocks_by_range/1/`
...
`/sila/beacon_chain/req/beacon_blocks_by_range/1/` is deprecated. Clients MAY
...
**Protocol ID:** `/sila/beacon_chain/req/beacon_blocks_by_root/1/`
...
`/sila/beacon_chain/req/beacon_blocks_by_root/1/` is deprecated. Clients MAY
respond with an empty list during the deprecation transition period.

##### Ping v1

**Protocol ID:** `/sila/beacon_chain/req/ping/1/`
...
**Protocol ID:** `/sila/beacon_chain/req/metadata/1/`
...
Discovery Version 5
([discv5](https://github.com/sila/devp2p/blob/master/discv5/discv5.md))
...
Although SecIO has wide language support, we won’t be using it for sila-mainnet
